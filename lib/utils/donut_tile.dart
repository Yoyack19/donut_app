...
class DonutTile extends StatelessWidget {
  ...
  const DonutTile({super.key, required this.sabordona, required this.preciodona, required this.colordona, required this.imagename, required this.proveedordonas, required this.onAdd});
                      ...
                      children: [
                         ...
                         TextButton(
                           onPressed: () {
                            ...
                            onAdd(price); //Actuliza el carrito                            
                           },
                           child: Text('Add',
